...
VALUES ('Lara', 'Blanco', 'D', TO_DATE('2017-06-10', 'YYYY-MM-DD'), '97958762Z', 'ES4320804469304329649513', 08700, 'Igualada', 'Barcelona', 'Espanya', 2025, 'C/ carrer 1', 'C:\jugadors\persona.jpg'); -- 8

INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Clara', 'Sanz', 'D', TO_DATE('2017-08-15', 'YYYY-MM-DD'), '26773311T', 'ES0500753882573669176662', 08700, 'Igualada', 'Barcelona', 'Espanya', 2025, 'C/ carrer 2', 'C:\jugadors\ogroids.jpg'); -- 8

INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Sara', 'Vidal', 'D', TO_DATE('2017-07-20', 'YYYY-MM-DD'), '00258888T', 'ES3914656485153417253568', 08700, 'Igualada', 'Barcelona', 'Espanya', 2025, 'C/ carrer 3', 'C:\jugadors\llop.jpg'); -- 9

INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Mia', 'Torres', 'D', TO_DATE('2017-01-05', 'YYYY-MM-DD'), '16797653V', 'ES5820383375769942562248', 08700, 'Igualada', 'Barcelona', 'Espanya', 2025, 'C/ carrer 4', 'C:\jugadors\nam.jpg'); -- 9

INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Nora', 'Morales', 'D', TO_DATE('2017-03-30', 'YYYY-MM-DD'), '76258289H', 'ES2014657779511731483325', 08700, 'Igualada', 'Barcelona', 'Espanya', 2025, 'C/ carrer 5', 'C:\jugadors\rocky.jpg'); -- 9


-- Jugadors per a l'equip Infantil Mixte (edats 12-13)
INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Oscar', 'Garcia', 'H', TO_DATE('2013-04-10', 'YYYY-MM-DD'), '54495074R', 'ES5114651661786979337188', 08700, 'Igualada', 'Barcelona', 'Espanya', 2024, 'C/ carrer 6', 'C:\jugadors\persona.jpg'); -- 13

INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Lucas', 'Cruz', 'H', TO_DATE('2013-10-05', 'YYYY-MM-DD'), '67045241B', 'ES8600818378813269557467', 08700, 'Igualada', 'Barcelona', 'Espanya', 2025, 'C/ carrer 7', 'C:\jugadors\ogroids.jpg'); -- 13

INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Noah', 'Hernandez', 'H', TO_DATE('2012-02-15', 'YYYY-MM-DD'), '55186663A', 'ES6920385493112987519953', 08700, 'Igualada', 'Barcelona', 'Espanya', 2024, 'C/ carrer 8', 'C:\jugadors\llop.jpg'); -- 12

INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Luca', 'Ramirez', 'D', TO_DATE('2012-05-22', 'YYYY-MM-DD'), '39300316D', 'ES7001286421647716485634', 08700, 'Igualada', 'Barcelona', 'Espanya', 2025, 'C/ carrer 9', 'C:\jugadors\nam.jpg'); -- 12

INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Elena', 'Fernandez', 'D', TO_DATE('2012-09-18', 'YYYY-MM-DD'), '01979086M', 'ES2001286329978731196623', 08700, 'Igualada', 'Barcelona', 'Espanya', 2024, 'C/ carrer 10', 'C:\jugadors\rocky.jpg'); -- 12

-- Jugadors per a l'equip Cadet Masculi (edats 14-15)
INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Alex', 'Perez', 'H', TO_DATE('2010-11-30', 'YYYY-MM-DD'), '12368881X', 'ES1620808385304282793513', 08700, 'Igualada', 'Barcelona', 'Espanya', 2024, 'C/ carrer 11', 'C:\jugadors\persona.jpg'); -- 15

INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Mateo', 'Serrano', 'H', TO_DATE('2010-05-25', 'YYYY-MM-DD'), '95433426D', 'ES3021003152038879392137', 08700, 'Igualada', 'Barcelona', 'Espanya', 2024, 'C/ carrer 12', 'C:\jugadors\ogroids.jpg'); -- 15
...
INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Victor', 'Martinez', 'H', TO_DATE('2008-07-30', 'YYYY-MM-DD'), '33556994V', 'ES6500757416515123666369', 08700, 'Igualada', 'Barcelona', 'Espanya', 2024, 'C/ carrer 19', 'C:\jugadors\nam.jpg'); -- 18

INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Liam', 'Salas', 'H', TO_DATE('2008-09-25', 'YYYY-MM-DD'), '58793407W', 'ES3314659116104762296934', 08700, 'Igualada', 'Barcelona', 'Espanya', 2024, 'C/ carrer 20', 'C:\jugadors\rocky.jpg'); -- 18

-- Jugadors per a l'equip Senior Femeni (edats 18-21)
INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Elisa', 'Dominguez', 'D', TO_DATE('2005-03-22', 'YYYY-MM-DD'), '68399800P', 'ES1001287177038478246641', 08700, 'Igualada', 'Barcelona', 'Espanya', 2024, 'C/ carrer 21', 'C:\jugadors\persona.jpg'); -- 21

INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Julia', 'Gonzalez', 'D', TO_DATE('2005-10-10', 'YYYY-MM-DD'), '36506272M', 'ES1020951336999497428946', 08700, 'Igualada', 'Barcelona', 'Espanya', 2024, 'C/ carrer 22', 'C:\jugadors\ogroids.jpg'); -- 22

INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Laura', 'Vidal', 'D', TO_DATE('2004-05-18', 'YYYY-MM-DD'), '48556386M', 'ES6301826642179435461978', 08700, 'Igualada', 'Barcelona', 'Espanya', 2024, 'C/ carrer 23', 'C:\jugadors\llop.jpg'); -- 22

INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Carmen', 'Sanchez', 'D', TO_DATE('2004-02-14', 'YYYY-MM-DD'), '69516791G', 'ES2100814775139974536543', 08700, 'Igualada', 'Barcelona', 'Espanya', 2024, 'C/ carrer 24', 'C:\jugadors\nam.jpg'); -- 19

INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Valeria', 'Romero', 'D', TO_DATE('2005-11-30', 'YYYY-MM-DD'), '30846170L', 'ES3004877216677372671331', 08700, 'Igualada', 'Barcelona', 'Espanya', 2024, 'C/ carrer 25', 'C:\jugadors\rocky.jpg'); -- 20


-- Jugadors per a l'equip Alevi Mixte (edats 9-11)
INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Maria', 'Lopez', 'H', TO_DATE('2015-04-10', 'YYYY-MM-DD'), '29279928P', 'ES5701825898971944371121', 08700, 'Igualada', 'Barcelona', 'Espanya', 2024, 'C/ carrer 6', 'C:\jugadors\persona.jpg'); -- 13

INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Joana', 'Dominguez', 'D', TO_DATE('2014-10-02', 'YYYY-MM-DD'), '32519365X', 'ES3320809667088282627132', 08700, 'Igualada', 'Barcelona', 'Espanya', 2024, 'C/ carrer 6', 'C:\jugadors\ogroids.jpg'); -- 13

INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Rita', 'Sanchez', 'D', TO_DATE('2015-01-13', 'YYYY-MM-DD'), '39278726Q', 'ES8804879153174777817157', 08700, 'Igualada', 'Barcelona', 'Espanya', 2025, 'C/ carrer 6', 'C:\jugadors\llop.jpg'); -- 13

INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Sebastian', 'Pozo', 'H', TO_DATE('2014-11-29', 'YYYY-MM-DD'), '13131877G', 'ES9604872959564874388281', 08700, 'Igualada', 'Barcelona', 'Espanya', 2024, 'C/ carrer 6', 'C:\jugadors\nam.jpg'); -- 13

INSERT INTO Jugador (nom, cognoms, sexe, data_naix, id_legal, IBAN, codi_postal, poblacio, provincia, pais, any_fi_revisio_medica, adreca, foto)
VALUES ('Manolo', 'Seguro', 'H', TO_DATE('2014-11-11', 'YYYY-MM-DD'), '92544371F', 'ES2304876461548981867482', 08700, 'Igualada', 'Barcelona', 'Espanya', 2025, 'C/ carrer 6', 'C:\jugadors\rocky.jpg'); -- 13
